...
def create_table_with_context(OUTPUT_PDF_PATH):
    """
    Extract and save all individual tables with totals added
    """
    result = get_docling_results(OUTPUT_PDF_PATH)
    full_markdown = result.document.export_to_markdown()
    
    print("\n" + "="*60)
    print("EXTRACTING AND SAVING TABLES WITH TOTALS")
    print("="*60)
    ...
    for table_ix, table in enumerate(result.document.tables):
        ...
        if "true" in classification_result.lower():
            ...
            print(f"✓ Saved table with total: {filename}")
...
if __name__ == "__main__":
    ...
    if relevant_pages:
        ...
        print("\n=== RUNNING PRODUCTION MODE WITH TOTALS ===")
